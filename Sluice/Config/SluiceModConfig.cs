...
namespace Sluice.Config
{
    public class SluiceModConfig
    {
        ...
        public List<CodeDropRates> BoneySoilDropRates = new()
        {
            ...
            new CodeDropRates { Code = new AssetLocation("game:lore-book-aged-brickred"), DropRate = 0.005f, Type = EnumItemClass.Item },
            new CodeDropRates { Code = new AssetLocation("game:lore-book-aged-cherryred"), DropRate = 0.005f, Type = EnumItemClass.Item },
            new CodeDropRates { Code = new AssetLocation("game:lore-book-aged-darkbeige"), DropRate = 0.005f, Type = EnumItemClass.Item },
            new CodeDropRates { Code = new AssetLocation("game:lore-book-aged-darkgray"), DropRate = 0.005f, Type = EnumItemClass.Item },
